...
export default function Home() {
  return (
    <div className="relative isolate flex min-h-full flex-col items-center justify-center bg-white dark:bg-black">
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-zinc-600 dark:text-zinc-400">
            Help us build the perfect product by sharing your bugs, feature requests, or suggestions. 
            All feedback is analyzed by FeedPulse AI to ensure your voice is heard.
          </p>
